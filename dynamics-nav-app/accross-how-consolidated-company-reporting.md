...
ms.locfileid: "7206"
---
# <a name="how-to-work-with-the-consolidated-trial-balance-report"></a>How To: Work with the Consolidated Trial Balance Report
...
## <a name="to-do-a-simple-consolidation-setup"></a>To do a simple consolidation setup 
...
## <a name="to-do-an-advanced-consolidation-setup"></a>To do an advanced consolidation setup
...
### <a name="to-prepare-general-ledger-accounts-for-consolidation"></a>To prepare general ledger accounts for consolidation 
...
### <a name="to-specify-exchange-rates-for-consolidations"></a>To specify exchange rates for consolidations
...
### <a name="to-exclude-a-company-from-consolidation"></a>To exclude a company from consolidation
...
### <a name="to-include-a-partially-owned-company-in-consolidation"></a>To include a partially-owned company in consolidation
...
## <a name="to-run-the-consolidation"></a>To run the consolidation
...
## <a name="to-export-data-from-dynamics-nav-and-import-it-in-included365finincludesd365finmdmd"></a>To export data from Dynamics NAV and import it in [!INCLUDE[d365fin](includes/d365fin_md.md)]
