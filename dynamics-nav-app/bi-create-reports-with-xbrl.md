...
## <a name="xbrl-is-comprised-of-the-following-components"></a>XBRL is comprised of the following components  
...
## <a name="to-set-up-xbrl-lines"></a>To set up XBRL lines  
