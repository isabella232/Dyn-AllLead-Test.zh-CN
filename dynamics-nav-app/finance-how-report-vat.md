...
ms.locfileid: "7440"
---
# <a name="how-to-report-vat-to-a-tax-authority"></a>How To: Report VAT to a Tax Authority
...
## <a name="about-the-vat-return-report"></a>About the VAT Return report
...
## <a name="to-set-up-vat-reports-in-included365finincludesd365finmdmd"></a>To set up VAT reports in [!INCLUDE[d365fin](includes/d365fin_md.md)]
...
## <a name="to-prepare-and-submit-a-vat-report"></a>To prepare and submit a VAT report
...
## <a name="submitting-vat-reports-manually"></a>Submitting VAT reports manually
...
## <a name="vat-settlement"></a>VAT settlement
...
## <a name="configuring-your-own-vat-reports"></a>Configuring your own VAT reports
