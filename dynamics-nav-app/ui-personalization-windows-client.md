...
ms.locfileid: "7086"
---
# <a name="personalizing-your-workspace-in-the-dynamics-windows-client"></a>Personalizing Your Workspace in the Dynamics Windows Client
...
## <a name="how-to-personalize-your-workspace"></a>How to personalize your workspace
...
### <a name="to-customize-a-ribbon"></a>To customize a ribbon
...
#### <a name="to-add-an-action"></a>To add an action
...
## <a name="customizing-fasttabs"></a>Customizing FastTabs
...
### <a name="to-customize-a-fasttab"></a>To customize a FastTab  
...
### <a name="to-add-move-or-remove-fasttabs"></a>To add, move, or remove FastTabs
...
### <a name="to-show-and-hide-fields-on-fasttabs"></a>To show and hide fields on FastTabs
...
### <a name="to-set-up-a-field-for-quick-entry"></a>To set up a field for Quick Entry
...
## <a name="customizing-factboxes"></a>Customizing FactBoxes
...
### <a name="to-customize-the-factbox-pane"></a>To customize the FactBox pane  
1.  Open the page that you want to change.
...
### <a name="to-add-a-factbox"></a>To add a FactBox  
...
### <a name="to-remove-a-factbox"></a>To remove a FactBox  

In the **Show FactBoxes in this order** box, select the FactBoxes , and then **Remove** button.   

### <a name="to-change-the-order-of-the-factboxes"></a>To change the order of the FactBoxes  
...
### <a name="to-change-the-fields-in-a-factbox"></a>To change the fields in a FactBox  
...
## <a name="customizing-columns-in-a-list-or-on-document-lines"></a>Customizing Columns in a List or on Document Lines
...
## <a name="customizing-the-navigation-pane"></a>Customizing the Navigation Pane
The navigation pane displays a menu of links to different list pages. Links are grouped under root-level buttons.

### <a name="to-customize-the-navigation-pane"></a>To customize the navigation pane  
...
### <a name="renaming-or-rearranging-buttons-in-the-navigation-pane"></a>Renaming or Rearranging Buttons in the Navigation Pane  
...
### <a name="to-add-a-new-menu-button"></a>To add a new menu button
...
### <a name="to-add-a-link-to-a-button"></a>To add a link to a button   
...
### <a name="to-move-or-copy-a-link-from-one-button-to-another"></a>To move or copy a link from one button to another  
...
### <a name="to-rearrange-the-order-of-a-links-under-a-button"></a>To rearrange the order of a links under a button  

1.  In the **Lists** pane, select the link that you want to move.  

2.  Use the **Move Up** and **Move Down** buttons to position the link.

## <a name="adding-department-links-to-the-role-center"></a>Adding Department Links to the Role Center
...
### <a name="to-copy-department-links-to-your-role-center"></a>To copy department links to your Role Center  
...
## <a name="adding-charts-to-role-centers-and-list-pages"></a>Adding Charts to Role Centers and List Pages
...
### <a name="to-add-a-generic-chart-to-your-role-center"></a>To add a generic chart to your Role Center  
...
### <a name="canceling-customization"></a>Canceling Customization
...
#### <a name="to-cancel-all-ui-customization-that-you-have-made-to-a-page"></a>To cancel all UI customization that you have made to a page  
...
#### <a name="to-cancel-ui-customization-that-you-have-made-to-a-ui-area-on-a-page"></a>To cancel UI customization that you have made to a UI area on a page  
...
### <a name="canceling-basic-ui-changes"></a>Canceling Basic UI Changes
