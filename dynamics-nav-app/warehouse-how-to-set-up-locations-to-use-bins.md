...
ms.locfileid: "7029"
---
# <a name="how-to-set-up-locations-to-use-bins"></a>How to: Set Up Locations to Use Bins
...
11. On the **Warehouse** FastTab, fill in the **Outbound Whse. Handling Time**, **Inbound Whse. Handling Time**, and the **Base Calendar Code** fields. For more information, see [How to: Set Up Base Calendars](across-how-to-assign-base-calendars.md).
